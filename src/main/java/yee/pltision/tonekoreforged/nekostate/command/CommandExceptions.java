...
public class CommandExceptions {
    public static SimpleCommandExceptionType
            PLAYER_NOT_NEKO,
            CANNOT_BE_OWN_NEKO_OR_OWNER,
            GET_NEKO_ALREADY, GET_NEKO_NEKO_CANNOT_HAVE_NEKO, GET_NEKO_CANNOT_MULTIPLE,GET_NEKO_OTHER_ALREADY,
            GET_OWNER_ALREADY, GET_OWNER_CANNOT_MULTIPLE,GET_OWNER_OTHER_ALREADY,
    ...
    public static void intiExceptions(){
        ...
        CANNOT_BE_OWN_NEKO_OR_OWNER=create(Lang.CANNOT_BE_OWN_NEKO_OR_OWNER);

        GET_NEKO_ALREADY=create(Lang.GET_NEKO_ALREADY);
        GET_NEKO_NEKO_CANNOT_HAVE_NEKO =create(Lang.GET_NEKO_NEKO_CANNOT_HAVE_OTHER_NEKO);
        GET_NEKO_CANNOT_MULTIPLE =create(Lang.GET_NEKO_CANNOT_MULTIPLE);
        GET_NEKO_OTHER_ALREADY=create(Lang.GET_NEKO_OTHER_ALREADY);

        GET_OWNER_ALREADY=create(Lang.GET_OWNER_ALREADY);
        GET_OWNER_CANNOT_MULTIPLE =create(Lang.GET_OWNER_CANNOT_MULTIPLE);
        GET_OWNER_OTHER_ALREADY=create(Lang.GET_OWNER_OTHER_ALREADY);
